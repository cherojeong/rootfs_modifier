...
DOWNLOAD_URL="http://cdimage.ubuntu.com/ubuntu-touch/$dist/daily-preinstalled"
DOWNLOAD_FILENAME=$dist-preinstalled-touch-armhf.tar.gz
DOWNLOAD_MANIFEST=$dist-preinstalled-touch-armhf.manifest
